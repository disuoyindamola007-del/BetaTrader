  ...
  return (
    <div className="animate-slide-up">
      ...
      <article className="px-4 pt-5 pb-8">
        <div className="flex items-center gap-2 text-xs theme-text-secondary mb-3"><span>{article.source}</span><span>&bull;</span><span>{formatDate(article.datetime)}</span></div>
        <h1 className="text-xl font-extrabold leading-tight mb-5 theme-text-primary">{article.headline}</h1>
        <div className="bg-emerald-500/8 border border-emerald-500/15 rounded-2xl p-4 mb-5">
          ...
          {isLoading && <div className="flex items-center gap-2 text-sm theme-text-secondary"><RefreshCw size={15} className="animate-spin" />Preparing summary...</div>}
          ...
          {!isLoading && !error && summary && (
            <div className="space-y-5 text-sm theme-text-primary leading-relaxed">
              <section>
                <h2 className="text-xs font-bold uppercase tracking-wider theme-text-primary mb-2">Overview</h2>
                <p>{summary.overview}</p>
              </section>
              <section>
                <h2 className="text-xs font-bold uppercase tracking-wider theme-text-primary mb-2">Key developments</h2>
              ...
              <section>
                <h2 className="text-xs font-bold uppercase tracking-wider theme-text-primary mb-2">Why it matters</h2>
                <p>{summary.whyItMatters}</p>
              </section>
              <section>
                <h2 className="text-xs font-bold uppercase tracking-wider theme-text-primary mb-2">Possible market impact</h2>
                <p>{summary.marketImpact}</p>
              </section>
              <section>
                <h2 className="text-xs font-bold uppercase tracking-wider theme-text-primary mb-2">What to watch next</h2>
                <ul className="space-y-2">
        ...
        <div className="glass-card p-4 mb-5"><p className="text-[10px] theme-text-secondary uppercase mb-2">Source description</p><p className="text-sm theme-text-primary leading-relaxed">{article.summary || 'The source did not provide an article description.'}</p></div>
