...
// Crypto now supports all timeframes via Kraken (1m/5m/15m) and CoinGecko (1h+)
// Kraken provides real minute-level candles for short intervals
const CRYPTO_TIMEFRAMES = ['1m', '5m', '15m', '1h', '4h', '1d', '1w'];
